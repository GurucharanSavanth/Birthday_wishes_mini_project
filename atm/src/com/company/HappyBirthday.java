...
public class HappyBirthday{
...

    {
        ...
        String sName, sYear, sMonth, sDay, sEmail;

        int iYearBorn, iMonthBorn, iDayBorn, iYearsOld, iDaysOld, iCalendarNowDayOfYear, iCalendarBdayDayOfYear, iCalendarNowYear, iCalendarBdayYear, email;

        BufferedReader dataIn= new BufferedReader(new InputStreamReader(System.in));

        System.out.println("Please enter your email.");

        sEmail = dataIn.readLine();
...
//calculate number of years and days old and assign to variables
        ...
        System.out.println("\t \n loading..." +
                ...
                "\n...." +
                "\n....." +
                "\nyour birthday mail is sent to ur e-mail successfully" +
                "\n Thank You ");
